...
#canadaQuad2 <- tslm(canadian.ts ~ poly(trend, 2, raw=TRUE))
#summary(canadaQuad2)
```
...
The accuracy of the two windows is shown below. 
...
plot(log(souvenir.ts), type = "n", xaxt = "n", xlab = "Year", ylab = "Sales (thousands)", main = "Log Souvenir Sales")
