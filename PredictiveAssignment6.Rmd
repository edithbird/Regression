...
It exhibits a strong positive autocorrelation at lag-1. This is apparent from the line at lag-1 that crosses the significance threshold and goes nearly to 1. 
...
head(walMart)
walMart.ts <- ts(walMart$Close, start = c(2001, 1), frequency = 365)
...
yrange <- range(walMart.ts)
#plot ts and linear trend
plot(c(2001, 2002), yrange, type="n", xlab="Year",  ylab = "Daily Closing Price",  main = "Daily Closing Price Wal Mart Stock", bty="l", xaxt="n", yaxt="n")
# Add the x-axis
axis(1, at=seq(2001,2002,12), labels=format(seq(2001,2002,12)))
# Add the y-axis
axis(2, at=seq(30,40, 1), labels=format(seq(30,40, 1)), las=2)
# Add the time series canadian
lines(canadian.ts, bty="l")
...
yrange
# Set up the plot
plot(c(1985, 1989), yrange, type="n", xlab="Year",  ylab="Appliance Shipments", bty="l", xaxt="n", yaxt="n",  main = "Quarterly Dept Store Sales ")
# Add the time series canadian
...
lines(applianceShipments.ts, col = "blue", type = "o")
```
...
# Set up the plot
plot(c(1985, 1989), yrange, type="n", xlab="Year",  ylab="Dept Store Sales (thousands)", bty="l", xaxt="n", yaxt="n",  main = "Exponential Trend  with Seasonality Model \nfit to Dept Store Sales ")
